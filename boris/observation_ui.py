...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalLayout_17f.setObjectName("verticalLayout_17f")
        self.splitter_5f = QtWidgets.QSplitter(self.tab_data_filesf)
        self.splitter_5f.setOrientation(QtCore.Qt.Vertical)
        self.splitter_5f.setObjectName("splitter_5f")
        self.layoutWidget_4f = QtWidgets.QWidget(self.splitter_5f)
        self.layoutWidget_4f.setObjectName("layoutWidget_4f")
        self.verticalLayout_15f = QtWidgets.QVBoxLayout(self.layoutWidget_4f)
        self.verticalLayout_15f.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_15f.setObjectName("verticalLayout_15f")
        self.label_7f = QtWidgets.QLabel(self.layoutWidget_4f)
        self.label_7f.setObjectName("label_7f")
        self.verticalLayout_15f.addWidget(self.label_7f)
        self.tw_data_filesf = QtWidgets.QTableWidget(self.layoutWidget_4f)
        self.tw_data_filesf.setSelectionMode(QtWidgets.QAbstractItemView.MultiSelection)
        self.tw_data_filesf.setObjectName("tw_data_filesf")
        self.tw_data_filesf.setColumnCount(9)
        self.tw_data_filesf.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.tw_data_filesf.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tw_data_filesf.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.tw_data_filesf.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.tw_data_filesf.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.tw_data_filesf.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.tw_data_filesf.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.tw_data_filesf.setHorizontalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        self.tw_data_filesf.setHorizontalHeaderItem(7, item)
        item = QtWidgets.QTableWidgetItem()
        self.tw_data_filesf.setHorizontalHeaderItem(8, item)
        self.verticalLayout_15f.addWidget(self.tw_data_filesf)
        self.layoutWidget_5f = QtWidgets.QWidget(self.splitter_5f)
        self.layoutWidget_5f.setObjectName("layoutWidget_5f")
        self.verticalLayout_16f = QtWidgets.QVBoxLayout(self.layoutWidget_5f)
        self.verticalLayout_16f.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_16f.setObjectName("verticalLayout_16f")
        self.horizontalLayout_5f = QtWidgets.QHBoxLayout()
        self.horizontalLayout_5f.setObjectName("horizontalLayout_5f")
        self.pb_add_data_filef = QtWidgets.QPushButton(self.layoutWidget_5f)
        self.pb_add_data_filef.setObjectName("pb_add_data_filef")
        self.horizontalLayout_5f.addWidget(self.pb_add_data_filef)
        self.pb_remove_data_filef = QtWidgets.QPushButton(self.layoutWidget_5f)
        self.pb_remove_data_filef.setObjectName("pb_remove_data_filef")
        self.horizontalLayout_5f.addWidget(self.pb_remove_data_filef)
        self.pb_view_data_headf = QtWidgets.QPushButton(self.layoutWidget_5f)
        self.pb_view_data_headf.setObjectName("pb_view_data_headf")
        self.horizontalLayout_5f.addWidget(self.pb_view_data_headf)
        self.pb_plot_dataf = QtWidgets.QPushButton(self.layoutWidget_5f)
        self.pb_plot_dataf.setObjectName("pb_plot_dataf")
        self.horizontalLayout_5f.addWidget(self.pb_plot_dataf)
        spacerItem5f = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_5f.addItem(spacerItem5f)
        self.verticalLayout_16f.addLayout(self.horizontalLayout_5f)
        spacerItem6f = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
    ...
    def retranslateUi(self, Form):
        ...
        item.setText(_translate("Form", "Path"))
        item = self.tw_data_filesf.horizontalHeaderItem(1)
        item.setText(_translate("Form", "Column to plot"))
        item = self.tw_data_filesf.horizontalHeaderItem(2)
        item.setText(_translate("Form", "Plot title"))
        item = self.tw_data_filesf.horizontalHeaderItem(3)
        item.setText(_translate("Form", "Y-axis title"))
        item = self.tw_data_filesf.horizontalHeaderItem(4)
        item.setText(_translate("Form", "X-axis bottom title"))
        item = self.tw_data_filesf.horizontalHeaderItem(5)
        item.setText(_translate("Form", "X-axis top title"))
        item = self.tw_data_filesf.horizontalHeaderItem(6)
        item.setText(_translate("Form", "Start position offset"))
        item = self.tw_data_filesf.horizontalHeaderItem(7)
        item.setText(_translate("Form", "Not Used"))
        item = self.tw_data_filesf.horizontalHeaderItem(8)
        item.setText(_translate("Form", "Color"))
        self.pb_add_data_filef.setText(_translate("Form", "Add SNIRF file"))
        self.pb_remove_data_filef.setText(_translate("Form", "Remove selected SNIRF file"))
