...
PLOT_DATA_FNIRS_FILEPATH_IDX = 0
PLOT_DATA_FNIRS_COLUMNS_IDX = 1
PLOT_DATA_FNIRS_PLOTTITLE_IDX = 2
PLOT_DATA_FNIRS_YAXIS_TITLE_IDX = 3
PLOT_DATA_FNIRS_XAXIS_BOTTOM_TITLE_IDX = 4
PLOT_DATA_FNIRS_XAXIS_TOP_TITLE_IDX = 5
PLOT_DATA_FNIRS_TIMEOFFSET_IDX = 6
PLOT_DATA_FNIRS_SUBSTRACT1STVALUE_IDX = 7
PLOT_DATA_FNIRS_PLOTCOLOR_IDX = 8

DATA_PLOT_FNIRS_FIELDS = {
    PLOT_DATA_FILEPATH_IDX: "file_path",
    PLOT_DATA_FNIRS_COLUMNS_IDX: "columns",
    PLOT_DATA_FNIRS_PLOTTITLE_IDX: "title",
    PLOT_DATA_FNIRS_YAXIS_TITLE_IDX: "yaxis_title",
    PLOT_DATA_FNIRS_XAXIS_BOTTOM_TITLE_IDX: "xaxis_bottom_title",
    PLOT_DATA_FNIRS_XAXIS_TOP_TITLE_IDX: "xaxis_top_title",
    PLOT_DATA_FNIRS_TIMEOFFSET_IDX: "time_offset",
